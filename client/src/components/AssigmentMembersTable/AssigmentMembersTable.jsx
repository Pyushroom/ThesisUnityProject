...
const AssignmentMembersTable = ({ teamId, onSelectUsers }) => {
    ...
    const fetchStudents = async () => {
      try {
        const res = await axios.get(
          `http://localhost:5000/server/users/${currentUser.id}/teams/team/${teamId}/students`
        );
...
export default AssignmentMembersTable;
